...
module.exports = {
  ...
  onStart: async function ({ api, event, args, usersData, userName, threadsData }) {
    ...
    var name2 = '${userName}'; // Replace with function that retrieves the name of the user
